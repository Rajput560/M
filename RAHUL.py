...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7685571959:AAGF7YcVvSTcezZXR56qZ3G1Gm1MbewUBH4'
...
async def start(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        await context.bot.send_message(chat_id=chat_id, text="*❌ YE BOT FREE NAHI H JISE LENA H BUY KARO @SUPERMANDDOS❌!!", parse_mode='Markdown')
        return
